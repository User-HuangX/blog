                        ...
                        <form class="compose-form" @submit.prevent="onComposeSubmit">
                            ...
                            <div class="editor-shell">
                                <aside class="editor-toolbar" aria-label="正文格式">
                                    ...
                                    <div class="font-size-picker" ref="fontSizePickerRef">
                                        <button type="button" class="font-size-trigger" @click.stop="toggleFontSizeMenu" title="字体大小">
                                            <span>{{ fontSizeLabel }}</span>
                                            <svg class="font-size-chevron" width="10" height="6" viewBox="0 0 10 6"><path d="M1 1l4 4 4-4" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                        </button>
                                    ...
                                    <button type="button" @click="setParagraph('P')" :class="{ 'toolbar-btn--active': activeBlockFormat === 'P' }">正文</button>
                                    <button type="button" @click="setParagraph('H2')" :class="{ 'toolbar-btn--active': activeBlockFormat === 'H2' }">H2</button>
                                    <button type="button" @click="setParagraph('H3')" :class="{ 'toolbar-btn--active': activeBlockFormat === 'H3' }">H3</button>
                                    <!-- 格式按钮：选中文字时自动高亮当前激活的格式 -->
                                    <button type="button" @click="applyCommand('bold')" :class="{ 'toolbar-btn--active': activeBold }"><b>加粗</b></button>
                                    <button type="button" @click="applyCommand('italic')" :class="{ 'toolbar-btn--active': activeItalic }"><i>斜体</i></button>
                                    <button type="button" @click="applyCommand('underline')" :class="{ 'toolbar-btn--active': activeUnderline }"><u>下划线</u></button>
                                    <button type="button" @click="applyCommand('strikeThrough')" :class="{ 'toolbar-btn--active': activeStrikeThrough }"><s>删除线</s></button>
                                    ...
                                    <button type="button" @click="applyCommand('formatBlock', 'blockquote')" :class="{ 'toolbar-btn--active': activeBlockFormat === 'BLOCKQUOTE' }">引用</button>
                                    ...
                                    <button type="button" @click="insertCodeBlock" :class="{ 'toolbar-btn--active': activeBlockFormat === 'PRE' }">代码块</button>
                                    <input
                                        ref="imageInputRef"
                                        type="file"
                                        accept="image/*"
